...
| `bx-sites-blog-versioning-i18n` | The blog (`docs/blog/posts/`), versioned docs (`docs/versions/`), translated locales (`docs/i18n/`), numbered courses (`docs/data/courses.yaml`), and redirects. |
